...
class _pizzaChoicePageState extends State<pizzaChoicePage>
  ...
  void initState() {
    ...
    _animation2 =Tween<double>(begin: 0,end: 1).animate(CurvedAnimation(parent: _controller, curve: Interval(0.5, 1)));
    _controller.forward(from: 0).whenComplete(() {
      _controller.repeat(min: 0.5,max: 1,period: Duration(seconds: 2));
    });
  }
